...
## 15 sep 2026 · Zonder account nodigt de app uit op de plek waar de sommelier stilstaat
Gebruikers zonder account kregen overal een eerlijke maar afwerende melding ("misschien niet de allerbeste keuzes") zonder knop, en nergens stond dat een account gratis is. Nu één banner (`accountBanner`) op scan, pairing, wijnkaart, flesdetail en in de kelder vanaf vijf wijnen, met steeds dezelfde zin: gratis, alleen e-mail en wachtwoord, niets te betalen, meteen twintig credits per maand. Onder het regelsadvies staat één vast voorbeeld van een sommelier-advies, als voorbeeld gemerkt. Afgewezen: een gratis proefadvies zonder account (de server eist een sessie en boekt credits; anoniem tegoed is niet te begrenzen), een eenmalige popup bij het openen (onderbreekt zonder aanleiding; de kelderbanner wacht tot er iets te adviseren valt en is weg te klikken), en de gratis stand als tweederangs neerzetten (de kelder zelf blijft bewust gratis en volwaardig).
