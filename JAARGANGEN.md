...
**Stand: 16 september 2026. 229 van de 815 jaren gecontroleerd.**
...
**Belangrijke beperking van deze ronde.** De sessie liep in een omgeving waarin de netwerkpolicy élk extern domein blokkeerde, ook Wikipedia. Er is daarom geen enkele bronpagina integraal gelezen: alles komt uit uittreksels die de zoekindex van die pagina's teruggaf. Van welk domein een uitspraak komt is daarmee bekend, de woordelijke context niet. Dat is zwakker dan de pagina zelf lezen, en het is de reden dat een aantal streken helemaal leeg bleef. Bovendien is het zoekbudget van 200 opdrachten opgeraakt. Bij een volgende ronde zijn twee dingen nodig: de bronnen hierboven op de netwerk-allowlist van de omgeving, of de ronde draaien vanaf een machine zonder proxy, plus een hoger zoekbudget (`CLAUDE_CODE_MAX_WEB_SEARCHES_PER_SESSION`).

## Wat de ronde veranderde, en welke denkfout eronder zat
